...
//正交解码模块通道  端口          可选范围              建议
#define FTM1_QDPHA_PIN  PTB0       //PTA8、PTA12、PTB0
#define FTM1_QDPHB_PIN  PTB1       //PTA9、PTA13、PTB1
...
#define SPI0_SIN_PIN    PTD3       // PTA17、PTC7、PTD3        全部都是 ALT2
...
/**********************************  CAN   ***************************************/
#define CAN0_TX_PIN     PTB18       //PTA12、PTB18              全部都是 ALT2
#define CAN0_RX_PIN     PTB19        //PTA13、PTB19              全部都是 ALT2
