...
#define GY901_UART   UART5
#define GY901_UART_RX_TX_IRQn      UART5_RX_TX_IRQn
#define GY901_UART_RX_TX_VECTORn   UART5_RX_TX_VECTORn


extern double yaw;
extern void GY901_init();
extern void gyrostst(void);
